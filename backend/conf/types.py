...
class CreateChatCompletionRequest(BaseModel):
    messages: List[conf.typedefs.ChatCompletionRequestMessage] = Field(
        default=[], description="A list of messages to generate completions for."
    )
    functions: Optional[List[conf.typedefs.ChatCompletionFunction]] = Field(
        default=None,
    ...
    tools: Optional[List[conf.typedefs.ChatCompletionTool]] = Field(
        default=None,
        description="A list of tools to apply to the generated completions.",
    )
    tool_choice: Optional[conf.typedefs.ChatCompletionToolChoiceOption] = Field(
        default=None,
    ...
    logit_bias: Optional[Dict[str, float]] = Field(None)
    seed: Optional[int] = Field(None)
    response_format: Optional[conf.typedefs.ChatCompletionRequestResponseFormat] = Field(
        default=None,
    )
    ...
    model_config = {
        "json_schema_extra": {
            "examples": [
                {
                    "messages": [
                        dict(ChatCompletionRequestMessage(
